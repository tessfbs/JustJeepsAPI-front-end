		...
		<Layout>
			...
			>
				...
				<Menu
					...
					style={{ backgroundColor: '#2938c3', color: '#D4F1F4' }}
					items={[
						{
							key: 'nav1',
							icon: <img src={keystone} alt='keystone' width='80px' />,
						},
						{
							key: 'nav2',
							icon: <img src={meyer} alt='meyer' width='80px' />,
						},
						{
							key: 'nav3',
							icon: <img src={omix} alt='omix' width='80px' />,
						},
						{
							key: 'nav4',
							icon: <UploadOutlined />,
